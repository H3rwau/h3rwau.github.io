...
1. 确定dp数组（dp table）以及下标的含义 **dp\[i]代表s中下标i之前的字符串能否被字典中的单词组合**
2. 确定递推公式 **if(word在原来的字典中&&dp[j]==true)dp[i]=true**
...
![](https://code-thinking-1253855093.file.myqcloud.com/pics/20230310000726.png)
...
## [#](https://programmercarl.com/背包总结篇.html#背包递推公式)背包递推公式
